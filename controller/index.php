...
if($flag == 1)
{
    ...
    if(isset($bio))
    {
        $db->query("INSERT INTO users (first_name, last_name, email,account_name, mobile_number,password) VALUES('$first_name', '$last_name', '$email' ,'$user_name',  '$mobile_number','$hash_password')");
    }
    else
    {
        $db->query("INSERT INTO users (first_name, last_name, email,account_name, mobile_number,password) VALUES('$first_name', '$last_name', '$email' ,'$user_name',  '$mobile_number','$hash_password')");
