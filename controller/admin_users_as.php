...
$result = $db->query("SELECT * FROM users WHERE username= '$username' AND password = '$hash_password'");
$user_count = $result->num_rows;

$validation_password = $db->query("SELECT * FROM users WHERE password = '$hash_password'");
$pass_count = $validation_password->num_rows;

$validation_user = $db->query("SELECT * FROM users WHERE  username = '$username'");
